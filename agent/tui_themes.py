...
_THEME_DEFS: dict[str, dict[str, Any]] = {
    ...
    "bengaluru": {
        "label": "Bengaluru — royal gold, jacaranda & garden night",
        "dark": True,
        "primary": "#e5a93c",
        "secondary": "#827494",
        "accent": "#b886ee",
        ...
        "variables": {
            "selene-muted": "#8f829c",
            "selene-faint": "#564a66",
            "selene-text-soft": "#ded6cc",
            "selene-border": "#3c2f54",
            "selene-border-soft": "#2b223c",
            "selene-border-focus": "#e5a93c",
            "selene-elevated": "#2b2340",
            "selene-select-fg": "#0e0c16",
            "selene-select-bg": "#e5a93c",
            "selene-content": "#201b30",
            "selene-user": "#4ec480",
        },
    },
    "scandinavia": {
        "label": "Scandinavia — ice & ghost blue",
        "dark": False,
        "primary": "#0078be",
        "secondary": "#3d607e",
        "accent": "#0090e0",
        ...
        "variables": {
            "selene-muted": "#3d607e",
            "selene-faint": "#628aa8",
            "selene-text-soft": "#18344c",
            "selene-border": "#7eaed0",
            "selene-border-soft": "#a0c8e2",
            "selene-border-focus": "#0078be",
            "selene-elevated": "#adcfe8",
            "selene-select-fg": "#ffffff",
            "selene-select-bg": "#0078be",
            "selene-content": "#bedbf0",
            "selene-user": "#098e5a",
        },
    },
}
